...
namespace Language_de {
  ...
  LSTR MSG_LEVEL_BED_NEXT_POINT           = _UxGT("Nächster Punkt");
  ...
  LSTR MSG_BED_TRAMMING                   = _UxGT("Ecken ausrichten");
  ...
  //                                       ...oder 2 Zeilen auf einem 3-Zeilen-Display.
    ...
    LSTR MSG_FILAMENT_CHANGE_PURGE        = _UxGT(MSG_1_LINE("Reinigen..."));
    LSTR MSG_FILAMENT_CHANGE_CONT_PURGE   = _UxGT(MSG_2_LINE("Klick zum beenden", "der Düsenreinigung"));
