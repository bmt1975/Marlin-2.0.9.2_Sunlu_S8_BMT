...
#define STRING_CONFIG_H_AUTHOR "BMT" // Who made the changes.
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 450, 450, 10, 50 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -34.5, 51.4, -2 }
...
#define HOMING_FEEDRATE_MM_M { (65*60), (65*60), (10*60) }
